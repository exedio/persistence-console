...
final class EnumSingletonIncomplete extends Item
{
	...
	{
		new EnumSingletonIncomplete(MyEnum.one);
	}

	/**
	 * Creates a new EnumSingletonIncomplete with all the fields initially needed.
				...
				com.exedio.cope.UniqueViolationException
	{
		this(new com.exedio.cope.SetValue<?>[]{
			com.exedio.cope.SetValue.map(EnumSingletonIncomplete.feature,feature),
		});
	}

	/**
	 * Creates a new EnumSingletonIncomplete and sets the given fields initially.
	 */
	@com.exedio.cope.instrument.Generated // customize with @WrapperType(genericConstructor=...)
	private EnumSingletonIncomplete(final com.exedio.cope.SetValue<?>... setValues){super(setValues);}
	...
	/**
	 * Gets the instance of enumSingletonIncomplete for the given value.
	...
	{
		return EnumSingletonIncomplete.feature.instance(EnumSingletonIncomplete.class,feature);
	}
	...
	/**
	 * The persistent type information for enumSingletonIncomplete.
	 */
	@com.exedio.cope.instrument.Generated // customize with @WrapperType(type=...)
	static final com.exedio.cope.Type<EnumSingletonIncomplete> TYPE = com.exedio.cope.TypesBound.newType(EnumSingletonIncomplete.class,EnumSingletonIncomplete::new);
	 ...
	 */
	@com.exedio.cope.instrument.Generated
	private EnumSingletonIncomplete(final com.exedio.cope.ActivationParameters ap){super(ap);}
}
